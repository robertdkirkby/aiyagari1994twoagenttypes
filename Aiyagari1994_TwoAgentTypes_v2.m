...
tic;
[V, Policy]=ValueFnIter_Case1_PType(n_d,n_a,n_z,Names_i,d_grid, a_grid, z_grid, pi_z, ReturnFn, Params, DiscountFactorParamNames, vfoptions);
toc
vfoptions.verbose=0;
...
tic;
StationaryDist=StationaryDist_Case1_PType(PTypeDistParamNames,Policy,n_d,n_a,n_z,Names_i,pi_z,Params,simoptions);
toc
...
AggVars=EvalFnOnAgentDist_AggVars_Case1_PType(StationaryDist, Policy, FnsToEvaluate, Params,n_d,n_a,n_z,Names_i,d_grid, a_grid, z_grid, simoptions);
...
[p_eqm,p_eqm_index,GeneralEqmConditions]=HeteroAgentStationaryEqm_Case1_PType(n_d, n_a, n_z, Names_i, n_p, pi_z, d_grid, a_grid, z_grid, ReturnFn, FnsToEvaluate, GeneralEqmEqns, Params, DiscountFactorParamNames, PTypeDistParamNames, GEPriceParamNames,heteroagentoptions, simoptions, vfoptions);
...
AggVars=EvalFnOnAgentDist_AllStats_Case1_PType(StationaryDist, Policy, FnsToEvaluate, Params,n_d,n_a,n_z,Names_i,d_grid, a_grid, z_grid, simoptions);
...
AllStats=EvalFnOnAgentDist_AllStats_Case1_PType(StationaryDist, Policy, FnsToEvaluateIneq, Params,n_d,n_a,n_z,Names_i,d_grid, a_grid, z_grid, simoptions);
